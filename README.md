...
Within this repo, you will see an overwhelming amount of webpages created which is hosted by the UNC Charlotte domain. This project as a whole is not meant to be pretty but to showcase
that I can competently create webpages in many fashions to display information in a suitable way.
